...
- **Dangerous commands / hub corruption** → "Dangerous Commands" and "Hub Recovery Workflow" sections in this file
...
**Correct response to prefix mismatch:** See [Hub Recovery Workflow](#hub-recovery-workflow) below.
